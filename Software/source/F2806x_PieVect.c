...
//
//
/* this function set a default addresses for the vector table functions if the interrupt is issued and there is no function set it
 * it execute the default function (which do nothing but stop the processor) you you have to set your function to its correct location in the vector table
 *    PieVectTable.ADCINT1 = &adc_isr; after
 *
*/
