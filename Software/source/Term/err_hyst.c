...
void InitErrHyst_dbg() {
	err_hyst[0][0] = (9L << 24) + (12L << 16) + (1L << 8) + 11;
	err_hyst[0][1] = (30L << 24) + (21L << 16) + (25L << 8) + 1;
	err_hyst[1][0] = (9L << 24) + (12L << 16) + (2L << 8) + 12;
	err_hyst[1][1] = (30L << 24) + (21L << 16) + (3L << 8) + 2;
	err_hyst[2][0] = (9L << 24) + (12L << 16) + (3L << 8) + 13;
	err_hyst[2][1] = (30L << 24) + (21L << 16) + (5L << 8) + 3;
	err_hyst[3][0] = (9L << 24) + (12L << 16) + (4L << 8) + 14;
	err_hyst[3][1] = (30L << 24) + (21L << 16) + (7L << 8) + 4;
	err_hyst[4][0] = (9L << 24) + (12L << 16) + (5L << 8) + 15;
	err_hyst[4][1] = (30L << 24) + (21L << 16) + (8L << 8) + 4;
	err_hyst[5][0] = (9L << 24) + (12L << 16) + (6L << 8) + 16;
	err_hyst[5][1] = (30L << 24) + (21L << 16) + (9L << 8) + 4;
	err_hyst[6][0] = (10L << 24) + (1L << 16) + (1L << 8) + 5;
	err_hyst[6][1] = (30L << 24) + (21L << 16) + (10L << 8) + 4;
	err_hyst[7][0] = (10L << 24) + (1L << 16) + (2L << 8) + 6;
	err_hyst[7][1] = (33L << 24) + (45L << 16) + (22L << 8) + 5;
	err_hyst[8][0] = (10L << 24) + (1L << 16) + (3L << 8) + 7;
	err_hyst[8][1] = (33L << 24) + (45L << 16) + (44L << 8) + 6;
	err_hyst[9][0] = (10L << 24) + (1L << 16) + (4L << 8) + 8;
	err_hyst[9][1] = (33L << 24) + (45L << 16) + (55L << 8) + 7;
	err_hyst[10][0] = (10L << 24) + (1L << 16) + (5L << 8) + 9;
	err_hyst[10][1] = (33L << 24) + (45L << 16) + (99L << 8) + 8;
	err_hyst[11][0] = (10L << 24) + (1L << 16) + (6L << 8) + 10;
	err_hyst[11][1] = (33L << 24) + (45L << 16) + (33L << 8) + 99;
	err_hyst[12][0] = (10L << 24) + (1L << 16) + (7L << 8) + 11;
	err_hyst[12][1] = (33L << 24) + (45L << 16) + (33L << 8) + 3;
	err_hyst[13][0] = (10L << 24) + (1L << 16) + (8L << 8) + 12;
	err_hyst[13][1] = (33L << 24) + (45L << 16) + (3L << 8) + 1;
	err_hyst[14][0] = (10L << 24) + (1L << 16) + (9L << 8) + 13;
	err_hyst[14][1] = (33L << 24) + (45L << 16) + (25L << 8) + 2;
#if 0
